...
export const metadata: Metadata = {
  ...
  description:
    "Amplifying perspectives from young people across Sierra Leone's districts through mobile recording and remote participation.",
  alternates: { canonical: "/district-voices" },
  openGraph: {
    title: "District Voices",
    description:
      "Amplifying perspectives from young people across Sierra Leone's districts through mobile recording and remote participation.",
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {districtVoices.map((d) => (
            <div key={d.district} className="rounded-2xl border border-navy/10 bg-white p-6 shadow-sm">
              <p className="text-xs font-bold uppercase tracking-wide text-green-ink">{d.region}</p>
              ...
              {d.episodeSlug && (
                <Link
                  ...
                  className="mt-4 inline-flex text-xs font-bold text-green-ink hover:text-green-ink-hover"
                >
